...
function MarioAnimation(){
  ...
  mario.addAnimation("stand",'imgs/mario/Layer7.png');
  mario.addAnimation("move",'imgs/mario/Layer1.png','imgs/mario/Layer2.png');
  mario.addAnimation("crouch",'imgs/mario/mario18.png');
  mario.addAnimation("jump",'imgs/mario/Layer1.png');
  mario.addAnimation("dead",'imgs/mario/Layer6.png');
};
